...
const HomeRoute = ({ photos, topics, isModalOpen, selectedPhoto, toggleModal, toggleFavorite, favoritePhotos, fetchPhotosByTopic }) => {
  ...
  return (
    <div className="home-route">
      ...
      <TopNavigation topics={topics} favoriteCount={favoritePhotos.length} fetchPhotosByTopic={fetchPhotosByTopic}/>
